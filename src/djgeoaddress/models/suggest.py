...
class AddressModel(VirtualModel):
    ...
    text = models.CharField(max_length=500, verbose_name=_("Full formatted address string"), help_text=_("Full formatted address string"))
    reference = models.CharField(max_length=255, blank=True, verbose_name=_("Backend reference ID"), help_text=_("Backend reference ID (place ID)"))
    address_line1 = models.CharField(max_length=255, blank=True, verbose_name=_("Address line 1"), help_text=_("Street number and name"))
    address_line2 = models.CharField(max_length=255, blank=True, verbose_name=_("Address line 2"), help_text=_("Building, apartment, floor"))
    ...
    country_code = models.CharField(max_length=10, blank=True, verbose_name=_("Country code"), help_text=_("ISO country code (e.g., FR, US, GB)"))
    municipality = models.CharField(max_length=255, blank=True, verbose_name=_("Municipality"), help_text=_("Municipality or local administrative unit"))
    neighbourhood = models.CharField(max_length=255, blank=True, verbose_name=_("Neighbourhood"), help_text=_("Neighbourhood, quarter, or district"))
    address_type = models.CharField(max_length=255, blank=True, verbose_name=_("Address type"), help_text=_("Address type or place type"))
    latitude = models.FloatField(null=True, blank=True, verbose_name=_("Latitude"), help_text=_("Latitude coordinate"))
    longitude = models.FloatField(null=True, blank=True, verbose_name=_("Longitude"), help_text=_("Longitude coordinate"))
    osm_id = models.CharField(max_length=255, blank=True, verbose_name=_("OSM ID"), help_text=_("OpenStreetMap ID"))
    osm_type = models.CharField(max_length=50, blank=True, verbose_name=_("OSM type"), help_text=_("OpenStreetMap type"))
    confidence = models.FloatField(null=True, blank=True, verbose_name=_("Confidence"), help_text=_("Confidence score (0-100%)"))
